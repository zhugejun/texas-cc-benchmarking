...
final as (
    select
        ...
        c.total_completions::numeric(10,0) as total_completions,
        c.associate_degrees::numeric(10,0) as associate_degrees,
        c.total_certificates::numeric(10,0) as total_certificates,
        c.certificates_under_1yr::numeric(10,0) as certificates_under_1yr,
        c.certificates_1_2yr::numeric(10,0) as certificates_1_2yr,

        -- Completion demographics (percentages - use number(10,2))
        c.pct_associate_hispanic::numeric(10,2) as pct_associate_hispanic,
        c.pct_associate_black::numeric(10,2) as pct_associate_black,
        c.pct_associate_white::numeric(10,2) as pct_associate_white,
        c.pct_associate_men::numeric(10,2) as pct_associate_men,
        c.pct_associate_women::numeric(10,2) as pct_associate_women,

        -- Graduation rates (use number(10,2))
        g.graduation_rate_150::numeric(10,2) as graduation_rate_150,
        g.transfer_out_rate::numeric(10,2) as transfer_out_rate,
        g.success_rate::numeric(10,2) as success_rate,

        -- Graduation rates by demographics
        g.grad_rate_hispanic::numeric(10,2) as grad_rate_hispanic,
        g.grad_rate_black::numeric(10,2) as grad_rate_black,
        g.grad_rate_white::numeric(10,2) as grad_rate_white,
        g.grad_rate_men::numeric(10,2) as grad_rate_men,
        g.grad_rate_women::numeric(10,2) as grad_rate_women,

        -- Equity gaps
        g.equity_gap_hispanic::numeric(10,2) as equity_gap_hispanic,
        g.equity_gap_black::numeric(10,2) as equity_gap_black,
        ...
        g.adjusted_cohort_total::numeric(10,0) as graduation_cohort_size,
        r.total_entering_undergrads::numeric(10,0) as retention_cohort_size
